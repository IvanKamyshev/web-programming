...
echo "Округление до целых: " . round($sqrt379) . "\n";
echo "Округление до десятых: " . round($sqrt379, 1) . "\n";
echo "Округление до сотых: " . round($sqrt379, 2) . "\n";
...
echo "Нужно сложить $count первых элементов массива, чтобы сумма получилась больше 10\n";